...
def main():
    ...
    if args.do_generate:
        ...
        if os.path.isfile(file):
            ...
            model.to(args.device)
            eval_examples, eval_data = load_and_cache_gen_data(
                args, '/home/$user/program_repair/CodeNet/data/LANG/processed/src_eval.LANG-LANG.LANG,/home/$user/program_repair/CodeNet/data/LANG/processed/tgt_eval.LANG-LANG.LANG'.replace("LANG", args.sub_task.split('-')[0]), pool, tokenizer, 'eval', only_src=True, is_sample=False
            )
    ...
    if args.do_multi_generate:
        ...
        if os.path.isfile(file):
            ...
            eval_examples, eval_data = load_and_cache_gen_data(
                args, '/home/$user/program_repair/CodeNet/data/LANG/processed_with_verdict/src_eval.LANG-LANG.LANG,/home/$user/program_repair/CodeNet/data/LANG/processed_with_verdict/tgt_eval.LANG-LANG.LANG'.replace("LANG", ), pool, tokenizer, 'eval', only_src=True, is_sample=False
            )
